...
# ============================
SESSION = environ.get('SESSION', 'anya_libert')   # Session name for the bot
API_ID = int(environ.get('API_ID', '27532508')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '8eacf34d816b70450f8d882282963b4b')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8254327437:AAEpMgTXvuGUKzLxClkZHXhpwalYHAwvChA")    # Bot token from @BotFather

# ============================
# Bot Settings Configuration
# ============================
CACHE_TIME = int(environ.get('CACHE_TIME', 200))    # Cache time in seconds (default: 5 minutes)
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/u2c21f.jpg https://files.catbox.moe/ufg55q.jpg https://files.catbox.moe/9h20bt.jpg https://files.catbox.moe/46fbj6.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://files.catbox.moe/ufg55q.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://files.catbox.moe/ufg55q.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://files.catbox.moe/46fbj6.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/ufg55q.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://files.catbox.moe/4qafxy.jpg https://files.catbox.moe/u2c21f.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2067321568').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003451137067').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003237464982'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003237464982'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003237464982'))  # Premium logs channel id
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003237464982').split()] #(make sure bot is admin)
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003445290327')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003048232121')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/anyalibertsupport')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003048232121")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1003410324009")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sonujohnson48_db_user:ypolPj3N0QUUoBfR@cluster0.tmkwst2.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'anyalibert_files') # Collection name (default: dreamcinezone_files)
...
VERIFY_IMG = environ.get("VERIFY_IMG", "https://files.catbox.moe/ovmkwl.gif")
...
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/dreamxbotz")   # Third tutoral link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/iqanimes') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'http://t.me/Obscuraperson') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+8jpV5puO7GE5Y2Fl') # Update channel link for the bot
...
LANGUAGES = {"English":"eng","Japanese":"jap"}
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'anyalibert'))
MULTI_CLIENT = False
name = str(environ.get('name', 'ANYALIBERT'))
