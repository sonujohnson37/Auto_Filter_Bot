...
PICS = (environ.get('PICS', 'https://files.catbox.moe/4qafxy.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://files.catbox.moe/ufg55q.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://files.catbox.moe/i25m77.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://files.catbox.moe/0774sr.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/09cwn3.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://files.catbox.moe/ufg55q.jpg')).split()  # Fsub pic
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002758990595').split()]  # Channel id for auto indexing (make sure bot is admin)
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003237464982')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003237464982')  # Request channel id (make sure bot is admin)
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'IQanime') # Collection name (default: dreamcinezone_files)
