...
# ============================
SESSION = environ.get('SESSION', 'iqanimes')   # Session name for the bot
...
BOT_TOKEN = environ.get('BOT_TOKEN', "7885980634:AAFxXRHuPkAgCKcs7Rg-8ozOUp1Jz-NoVHk")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/ovmkwl.gif https://files.catbox.moe/htfv7i.jpg https://files.catbox.moe/sqfy3j.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://files.catbox.moe/sqfy3j.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://files.catbox.moe/72fcnu.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://files.catbox.moe/ovmkwl.gif")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/htfv7i.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://files.catbox.moe/72fcnu.jpg')).split()  # Fsub pic
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002477125005'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002477125005'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002477125005'))  # Premium logs channel id
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002477125005').split()] #(make sure bot is admin)
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003445290327')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003218871867')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/anyalibertsupport')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003445290327")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1003445290327")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('')    # QR code image for payments
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Anya_files') # Collection name (default: dreamcinezone_files)
...
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/IQanpossible') # Update channel link for the bot
...
MSG_ALRT = environ.get('MSG_ALRT', 'Huh! what are you doing 😒') # Alert message for users
DELETE_TIME = int(environ.get("DELETE_TIME", "250"))  #  deletion time in seconds (default: 5 minutes). Adjust as per your needs.
...
LANGUAGES = {"ᴇɴɢʟɪsʜ":"eng","japanese":"jap","Multi Audio":"multi"}
